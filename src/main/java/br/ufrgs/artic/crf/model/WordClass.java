...
public enum WordClass {
    ...
    JOURNAL_NAME, JOURNAL_VOLUME, JOURNAL_YEAR, JOURNAL_PAGE, WEBSITE, CONFERENCE_NAME, CONFERENCE_PAGE,
    CONFERENCE_YEAR, CONFERENCE_LOCATION, CONFERENCE_DATE, CONFERENCE_NUMBER, CONFERENCE_VOLUME,
    PUBLISHER, DOI, ISSN, ISBN,
    AFFILIATION, AUTHOR, EMAIL, OTHER, TITLE;
