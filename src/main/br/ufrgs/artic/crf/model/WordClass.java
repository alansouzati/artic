...
public enum WordClass {
    ...
    JOURNAL_NAME, JOURNAL_VOLUME, JOURNAL_YEAR, JOURNAL_PAGE, WEBSITE, CONFERENCE_NAME, CONFERENCE_YEAR, CONFERENCE_LOCATION, CONFERENCE_DATE, CONFERENCE_NUMBER, OTHER;
