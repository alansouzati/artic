...
//////////////////////////////////
     ...
     * - [`bind()`](http://api.jquery.com/on/) - Does not support namespaces, selectors or eventService
     ...
     * - [`on()`](http://api.jquery.com/on/) - Does not support namespaces, selectors or eventService
...
//////////////////////////////////////////
    forEach({
        ...
        on: function onFn(element, type, fn, unsupported) {
            if (isDefined(unsupported)) throw jqLiteMinErr('onargs', 'jqLite#on() does not support the `selector` or `eventService` parameters');
        ...
        triggerHandler: function (element, eventName, eventService) {
            ...
            forEach(eventFns, function (fn) {
                fn.apply(element, event.concat(eventService));
            });
        }
    }, function (fn, name) {
        /**
